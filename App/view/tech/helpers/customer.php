...
$meterData = $database->select($meter->table_name, [
    "meter_unique", "meter_number", "meter_lock"
], 
[
...
$bdata = $database->query(
    "SELECT bill_reg_date, bill_unit_used, bill_cost, bill_unit,bill_id
    FROM bill 
...
$pdata = $pdatabase->query(
    "SELECT pay_reg_date,pay_amount, bill_cost  FROM payments  
