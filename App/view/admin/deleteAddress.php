            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processDeleteAddress.php" method="post">
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="text" 
                                        ...
                                        value="<?=$data[0]['address_name']?>" readonly>
                                </div>
                               
                                <div class="row">
                                    <button type="submit" class="btn btn-danger btn-block col-lg-3 offset-lg-2">Delete</button>
                                </div>
                            </form>
                        </div>
                    </div>
