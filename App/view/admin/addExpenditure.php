...
$_SESSION['_addExpenditure_token'] = bin2hex(random_bytes(32));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddExpenditure.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addExpenditure_token']?>">
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Item
                                    </label>
                                    <input type="text" name="item" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Description
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="text" name="amount" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Cost / Item
                                    </label>
                                    <input type="text" name="item_cost" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Supplied By
