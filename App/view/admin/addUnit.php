...
$_SESSION['_addUnit_token'] = bin2hex(random_bytes(32));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddUnit.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addUnit_token']?>">
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="number" step="0.01" name="unit_price" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row">
