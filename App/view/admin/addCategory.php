...
$_SESSION['_addCategory_token'] = bin2hex(random_bytes(32));
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Inventory Category</h1>
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddCategory.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addCategory_token']?>">
