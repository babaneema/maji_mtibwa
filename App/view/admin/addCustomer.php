...
$_SESSION['_addCustomer_token'] = bin2hex(random_bytes(32));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddCustomer.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addCustomer_token']?>">
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="text" name="address" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Customer House No.
                                    </label>
                                    <input type="text" name="house" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row">
