...
$_SESSION['_addEmployee_token'] = bin2hex(random_bytes(32));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddEmployee.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addEmployee_token']?>">
