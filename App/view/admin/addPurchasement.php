...
$_SESSION['_addPurchase_token'] = bin2hex(random_bytes(32));
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4 border-left-success ">
                        ...
                        <div class="card-body">
                            <form action="../../controller/admin/processAddPurchasement.php" method="post">
                                <input type="hidden" name="token" value="<?=$_SESSION['_addPurchase_token']?>">
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                        Equipment 
                                    </label>
                                    <select name="equipment" id=""  class="col-lg-3 form-control" required>
                                ...
                                <div class="row form-group">
                                    ...
                                    <select name="category"  class="col-lg-3 form-control" required>
                                        <option value="">---Select -----</option>
                                        <?php
                                            $database->select($category->table_name, "*", function($data){
                                                ?>
                                                <option value="<?=$data['catgory_id']?>">
                                                    <?=$data['category_name']?> 
                                                </option>
                                                <?php
                                            }); 
                                ...
                                <div class="row form-group">
                                    ...
                                    <input type="text" name="measurement" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                       Price
                                    </label>
                                    <input type="text" name="price" class="col-lg-3 form-control" required>
                                </div>
                                <div class="row form-group">
                                    <label for="Name" class="col-lg-2 form-control-label">
                                       Quantity
